    ...
    <section className="bg-[#f5f1eb] py-12 px-4 sm:py-16 sm:px-6 md:py-20 md:px-8 lg:py-24 lg:px-12 xl:px-16">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 sm:mb-16 max-w-full">
          <h2 className="mb-6 text-3xl font-[HelveticaWorldRegular] tracking-wider sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight text-gray-900">
            ...
            >
              {testimonials.map((testimonial) => (
                <SwiperSlide key={testimonial.id}>
                  ...
                  >
                    <blockquote className="text-lg  font-[GaretRegular] sm:text-xl leading-relaxed text-gray-900 flex-grow mb-6">
                      "{testimonial.quote}"
                    </blockquote>
                    <div>
                      <div className="font-semibold font-[HelveticaWorldRegular] tracking-wider text-gray-900 text-lg">{testimonial.name}</div>
                      <div className="text-gray-600 font-[HelveticaWorldRegular] tracking-wider">{testimonial.location}</div>
                    </div>
                  </div>
                </SwiperSlide>
              ))}
