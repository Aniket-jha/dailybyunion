  ...
  return (
    <div className="px-4 py-8 lg:px-16 lg:py-12 bg-[#ebebeb]">
       ...
       <div className='flex lg:px-8 items-start justify-start flex-col w-full'>
        <h3 className='text-center text-[1.4rem] lg:text-[2.5rem] text-[#75665f] font-[PlayfairBold]'>Contact Us</h3>
        ...
        <div className='flex items-center flex-wrap w-full gap-3 mt-3 '>
            <div className='flex items-start w-full lg:w-[47%]  flex-col'>
                <label className='font-[PlayfairMedium] text-[1.1rem]'>Full Name</label>
            ...
            <div className='flex items-startw-full w-full lg:w-[47%] flex-col'>
                <label className='font-[PlayfairMedium] text-[1.1rem]'>Mobile Number</label>
                <input className='px-3 py-3 font-[NeueRegular] rounded-lg w-full border-[1px] border-[#c6c6c6]' placeholder='Phone Number' />
            </div>
        </div>
        <div className='flex items-center flex-wrap w-full gap-3 mt-3 '>
            <div className='flex items-start w-full lg:w-[47%]  flex-col'>
                <label className='font-[PlayfairMedium] text-[1.1rem]'>Check In</label>
            ...
            <div className='flex items-start w-full lg:w-[47%] flex-col'>
                <label className='font-[PlayfairMedium] text-[1.1rem]'>Check Out</label>
            ...
            <div className='flex items-start w-full lg:w-[47%] flex-col'>
                <label className='font-[PlayfairMedium] text-[1.1rem]'>Location</label>
            ...
            <div className='flex items-start w-full lg:w-[47%] flex-col'>
                <label className='font-[PlayfairMedium] text-[1.1rem]'>No of Rooms</label>
