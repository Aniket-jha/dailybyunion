  ...
  return (
    ...
    <div className='md:grid grid-col-7 grid-flow-col' >
        ...
        <div className='col-span-5 flex lg:items-start justify-around pb-4 lg:flex-row flex-col gap-6    mt-3 md:mt-4' >
                <div>
                    <h3 className='font-[PlayfairMedium] text-[1.5rem] text-[#272727]'>Sitemap</h3>
                    <div>
                ...
                <div>
                    <h3 className='font-[PlayfairMedium] text-[1.5rem] text-[#272727]'>Important Links</h3>
                    <div>
        ...
        <div className='col-span-1 mt-3 md:mt-6' >
         ...
         <strong className='font-[PlayfairBold]' >  Customer Service </strong> 
         <br />
