        ...
        <div className="bg-white rounded-2xl shadow-2xl p-0">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div className="space-y-2 flex lg:border-r-[1px] border-[#272727] flex-col items-center relative" ref={dropdownRef}>
              <label className="text-base pt-4 font-[HelveticaWorldRegular] tracking-wider text-black uppercase tracking-wide">DESTINATION</label>
            ...
            <div className="space-y-2 lg:border-r-[1px] border-[#272727] flex flex-col items-center relative" ref={checkInRef}>
              <label className="text-base pt-4 font-[HelveticaWorldRegular] tracking-wider text-black uppercase tracking-wide">CHECK IN</label>
            ...
            <div className="space-y-2 lg:border-r-[1px] border-[#272727] flex flex-col items-center relative" ref={checkOutRef}>
              <label className="text-base pt-4 font-[HelveticaWorldRegular] tracking-wider text-black uppercase tracking-wide">CHECK OUT</label>
            ...
            <div className="space-y-2 lg:border-r-[1px] border-[#272727] flex flex-col items-center">
              <label className="text-base pt-4 font-[HelveticaWorldRegular] tracking-wider text-black uppercase tracking-wide">GUESTS</label>
