    ...
    <div className="relative bg-black h-auto py-12 lg:py-24 parallax-bg">
      ...
      <div className="relative z-10 px-6 lg:px-20 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          {/* Left Side */}
          <div>
            <h3 className="text-[1.5rem] lg:text-[2.5rem] font-[HelveticaWorldRegular] tracking-wider mb-4">
          ...
          {/* Right Side */}
          <div>
            <h3 className="font-[HelveticaWorldRegular] tracking-wider text-[1.2rem] lg:text-[1.5rem] leading-relaxed">
              <i>{desc}</i>
            </h3>
          </div>
