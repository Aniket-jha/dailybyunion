  ...
  return (
    <section className="bg-white py-16 px-6 md:py-24 md:px-12 lg:px-16">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="mb-12">
          <h2 className="text-3xl md:text-4xl font-[LexandMedium] tracking-tighter font-light text-gray-900">FAQs</h2>
        </div>
        ...
        <div className="space-y-0">
          {faqs.map((faq, index) => (
            <div key={faq.id} className="border-b border-gray-200">
              ...
              >
                <span className="text-lg md:text-xl font-[LexandMedium] tracking-tighter text-gray-900 pr-8 leading-relaxed">{faq.question}</span>
                <LuChevronDown
