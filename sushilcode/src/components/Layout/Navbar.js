...
export default function NavbarTwo() {
  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col font-[HelveticaWorldRegular] tracking-wider text-[#ffffff]  lg:mb-0 lg:mt-0 lg:justify-end lg:flex-row lg:items-center lg:gap-6">
