  ...
  return (
    <div  className="mx-4 my-8 lg:mx-16 lg:my-16">
        ...
        <div>
            ...
            <div>
            <h3 className='text-[1.5rem] font-[LexandMedium] tracking-tighter mb-1 lg:text-[2.5rem]'>Why Choose <span className='text-[#75665f] italic uppercase'>The Daily Stays? </span> </h3>
