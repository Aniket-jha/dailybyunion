      ...
      <div className="max-w-8xl ml-auto mr-0 ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-[28px] font-[HelveticaWorldRegular] tracking-wider lg:text-[2.5rem]  text-gray-900 leading-tight mb-4">
                Corporate Stays 
              </h2>
              <p className=" text-[18px] lg:text-[20px] font-[HelveticaWorldRegular] tracking-wider text-[#8a7970]  relative inline-block mb-2">
          The ultimate shortstay solution for professionals on the move
            ...
            <div className="space-y-4">
              <p className="text-[14px] font-[GaretRegular] lg:text-[16px] text-gray-700 leading-relaxed"> 	
