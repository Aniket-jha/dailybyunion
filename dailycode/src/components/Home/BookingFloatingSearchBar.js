      ...
      <div className="w-full bg-white shadow-2xl border border-gray-200 overflow-visible">
        <div className="grid grid-cols-1 md:grid-cols-5 divide-y md:divide-y-0 md:divide-x">
          ...
          <div className="flex flex-col items-center py-4 px-6 relative">
            <label className="text-sm text-gray-700 font-[LexandMedium] tracking-tighter uppercase mb-2">Destination</label>
            <div
          ...
          {/* Check In */}
          <div className="flex flex-col items-center py-4 px-6 relative">
            <label className="text-sm text-gray-700 font-[LexandMedium] tracking-tighter uppercase mb-2">Check In</label>
            <div
          ...
          {/* Check Out */}
          <div className="flex flex-col items-center py-4 px-6 relative">
            <label className="text-sm text-gray-700 font-[LexandMedium] tracking-tighter uppercase mb-2">Check Out</label>
            <div
          ...
          <div className="flex flex-col items-center py-4 px-6">
            <label className="text-sm text-gray-700 font-[LexandMedium] tracking-tighter uppercase mb-2">Guests</label>
