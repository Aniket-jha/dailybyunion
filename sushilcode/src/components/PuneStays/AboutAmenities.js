  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-gray-50 py-8 px-4 md:px-8 rounded-md">
        <h3 className="text-xl md:text-2xl font-[LexandSemibold] tracking-tighter mb-6">Privileges</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-green-50 py-8 px-4 md:px-8 rounded-md">
        <h3 className="text-xl md:text-2xl font-[LexandSemibold] tracking-tighter mb-6">Neighbourhood</h3>
        <div className=" text-gray-700">
