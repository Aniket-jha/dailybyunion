          ...
          return (
            ...
            >
                  ...
                  {room.images.map((src, index) => (
                    <SwiperSlide key={index}>
                      <Image
                        ...
                        className="object-cover h-[250px] lg:w-full lg:h-full"
                      />
                    </SwiperSlide>
                  ))}
                </Swiper>
              ...
              <div className="p-6 flex flex-col justify-center md:w-[50%]">
                ...
                <a href={link} className="bg-black text-white text-center py-2 px-2 font-[GaretRegular] rounded-lg hover:bg-gra text-sm tracking-wider uppercase">
                  Check Availability
                </a>
              </div>
            </div>
