        ...
        <div className="bg-white rounded-2xl shadow-2xl p-0">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5  ">
            ...
            <div className="space-y-2 flex border-b-[1px] lg:border-r-[1px] border-[#272727] flex-col items-center">
              <label className="text-sm pt-4 font-[LexandMedium] tracking-tighter text-gray-700 uppercase tracking-wide">DESTINATION</label>
            ...
            <div className="space-y-2 border-b-[1px] lg:border-r-[1px] border-[#272727] flex flex-col items-center">
              <label className="text-sm pt-4 font-[LexandMedium] tracking-tighter text-gray-700 uppercase tracking-wide">CHECK IN</label>
              <div className="relative">
                <input
                  type="date"
            ...
            {/* Check Out */}
            <div className="space-y-2 border-b-[1px] lg:border-r-[1px] border-[#272727] flex flex-col items-center">
              <label className="text-sm pt-4 font-[LexandMedium] tracking-tighter text-gray-700 uppercase tracking-wide">CHECK OUT</label>
              <div className="relative">
                <input
                  type="date"
                  className="w-full p-4 text-gray-600 bg-transparent border-0 focus:outline-none cursor-pointer text-base"
            ...
            {/* Guests */}
            <div className="space-y-2 border-b-[1px] lg:border-r-[1px] border-[#272727] flex flex-col items-center">
              <label className="text-sm pt-4 font-[LexandMedium] tracking-tighter text-gray-700 uppercase tracking-wide">GUESTS</label>
