...
const MissionVision = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2  items-start grid-flow-row' >
        <div className=' px-12 py-16 text-[#66694A] border-r-[1px]  flex items-start justify-center gap-12 border-black '>
        ...
        <div className=' px-12 text-[#66694A] py-16  flex items-start justify-center gap-12 '>
